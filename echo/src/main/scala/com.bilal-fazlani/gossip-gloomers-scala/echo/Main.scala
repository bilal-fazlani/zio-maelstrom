...
object Main extends ZIOAppDefault:
  val app = MaelstromApp.collectMessages[Echo](in => in reply EchoOk(echo = in.body.echo, in_reply_to = in.body.msg_id))
  val run = MaelstromRuntime run(app, NodeInput.FilePath("echo" / "testing.txt"))
