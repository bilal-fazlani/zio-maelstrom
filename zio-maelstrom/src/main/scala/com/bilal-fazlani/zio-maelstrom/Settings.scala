...
/** Settings for the node
  ...
  * @param logLevel You can log messages using logInfo or logError. Output logs can be filtered by setting this value to either Disabled, Info or Error. Default is Info
  * @param logFormat You can choose between colored or plain logs. Default is colored
  * @param concurrency Concurrency level for processing messages. Default is 1024. 
